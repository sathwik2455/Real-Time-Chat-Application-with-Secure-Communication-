		...
		<div className='w-full max-w-md mx-auto'>
			<div className='frost-panel p-7 rounded-2xl'>
				<h1 className='text-3xl font-semibold text-center text-slate-100'>
					Sign Up <span className='text-cyan-300'> ChatApp</span>
				</h1>

				<form onSubmit={handleSubmit} className='mt-4 space-y-2'>
					<div>
						<label className='label p-2'>
							<span className='text-base text-sky-100'>Full Name</span>
						</label>
						<input
							type='text'
					...
					<div>
						<label className='label'>
							<span className='text-base text-sky-100'>Confirm Password</span>
						</label>
						<input
							type='password'
					...
					<Link
						to={"/login"}
						className='text-sm hover:underline text-cyan-200 hover:text-cyan-100 mt-2 inline-block'
						href='#'
					>
